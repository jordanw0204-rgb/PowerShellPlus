    ...
    public async Task<bool> RunMultiPaneSmokeTestAsync(string reportPath)
    {
        ...
        try
        {
            ...
            var success = inputReady && outputReady && scrollbarsHidden && titleLayoutControlsCentered && sidebarCollapses && sidebarExpands && sidebarStatePersists
                && terminalSurfaceHooked && terminalInputRouterPrecedesConPty && remoteImagePasteIndicatorReady && remoteImageShortcutInterceptReady && remoteImagePasteModesWork && remoteSshPasteConsumesAllClipboardKinds && remoteImagePasteIndicatorStatesWork
